...
const About = () => {
    return (
        <div id='about' className='flex flex-col my-16 md:px-40 px-14'>
            ...
            <div className='flex flex-col md:flex-row my-10'>
                <div className='md:flex-1 flex flex-row justify-center items-center z-10'>
                    <div className='bg-gradient-to-tr from-bg-primary via-primary to-bg-primary rounded-2xl'>
                        <img alt="about" src={about2} className="w-96 h-96 rotate-6 hover:rotate-0 rounded-2xl object-cover" sizes={30} />
                    </div>
                </div>
